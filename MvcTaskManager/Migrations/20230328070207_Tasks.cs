        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskStatusDetail_Tasks_TaskID",
                        column: x => x.TaskID,
                        principalTable: "Tasks",
                        principalColumn: "TaskID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskStatusDetail_TaskStatuses_TaskStatusID",
                        column: x => x.TaskStatusID,
                        principalTable: "TaskStatuses",
                        principalColumn: "TaskStatusID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskStatusDetail_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusDetail_TaskID",
                table: "TaskStatusDetail",
                column: "TaskID");

            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusDetail_TaskStatusID",
                table: "TaskStatusDetail",
                column: "TaskStatusID");

            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusDetail_UserID",
                table: "TaskStatusDetail",
                column: "UserID");
        }
