...
{
    public partial class iniottr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, false, 1, new DateTime(2016, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Library Management System", "In Force", 16 },
                    { 1, true, 2, new DateTime(2017, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hospital Management System", "In Force", 14 },
                    { 4, true, 2, new DateTime(2014, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bitcoin CRM", "In Force", 20 },
                    { 3, true, 3, new DateTime(2015, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "School Management System", "In Force", 18 }
                });
